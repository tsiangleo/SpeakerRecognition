...
public class RecognitionServiceCNNRNN {
    ...
    public static final String MODEL_FILE = "file:///android_asset/3rnn_256_10batchsize.pb"; //模型存放路径
...
//    private double[] inputs = new double[HEIGHT*WIDTH];    //用于存储的模型输入数据
    ...
    public RecognitionServiceCNNRNN(Context context){
